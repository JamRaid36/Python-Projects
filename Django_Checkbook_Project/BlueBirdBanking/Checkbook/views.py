...
def home(request):
    form = TransactionForm(data=request.POST or None)  # Retrieve transaction from form
...
def balance(request, pk):
    ...
    table_contents = {}  # Create a dictionary in which transaction information will be placed
